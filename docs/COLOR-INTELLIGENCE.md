...
Color Intelligence is the **core engine** of @zuclubit/momoto-ui that manages all color operations through perceptual science. It guarantees:
...
```typescript
import { OklchColor } from '@zuclubit/momoto-ui/domain';
...
```typescript
import { HctColor } from '@zuclubit/momoto-ui/domain';
...
```typescript
import { interpolateColors } from '@zuclubit/momoto-ui/domain';
...
```typescript
import { ValidateAccessibility } from '@zuclubit/momoto-ui/application';
...
```typescript
import { DeriveColorPalette } from '@zuclubit/momoto-ui/application';
...
```typescript
import { GenerateComponentTokens } from '@zuclubit/momoto-ui/application';
...
```typescript
import { TokenCollection } from '@zuclubit/momoto-ui/domain';
...
```typescript
import { ExportDesignTokens } from '@zuclubit/momoto-ui/application';
