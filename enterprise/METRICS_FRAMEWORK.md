# @zuclubit/momoto-ui — Quality & Adoption Metrics Framework

> **Version:** 1.0.0
> **Measurement Cadence:** Continuous + Weekly Rollup
> **Dashboard:** metrics.zuclubit.internal/momoto-ui
...
│  • Build Failure Rate (by momoto-ui)                                │
│                                                                  │
...
**Definition:** % de proyectos usando @zuclubit/momoto-ui con configuración mínima válida.
...
interface AdoptionRate {
  ...
  // Projects con momoto-ui instalado
...
**How measured:**
```bash
npx @zuclubit/momoto-ui conformance --json
```
...
**How measured:**
```bash
npx @zuclubit/momoto-ui accessibility --standard=wcag-aa --json
```
...
**How measured:**
```bash
npx @zuclubit/momoto-ui token-coverage --json
```
...
### Build Failure Rate (momoto-ui related)

**What:** % de builds que fallan por violaciones de momoto-ui
...
**Target:** < 5% of builds should fail due to momoto-ui
...
```bash
# Generate reports
npx @zuclubit/momoto-ui report --type=daily --format=slack
npx @zuclubit/momoto-ui report --type=weekly --format=markdown --output=weekly-report.md
npx @zuclubit/momoto-ui report --type=monthly --format=html --output=monthly-report.html
```
