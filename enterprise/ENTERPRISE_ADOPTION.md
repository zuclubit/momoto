# @zuclubit/momoto-ui — Enterprise Adoption Guide
...
`@zuclubit/momoto-ui` es la **infraestructura visual corporativa** de Zuclubit. No es una librería opcional — es el **single source of truth** para:
...
import { ENTERPRISE_POLICIES } from '@zuclubit/momoto-ui';
...
npx @zuclubit/momoto-ui create-app my-project --preset=standard
...
- [ ] Ejecutar `npx @zuclubit/momoto-ui doctor` en el proyecto
...
npx @zuclubit/momoto-ui doctor --verbose

# Análisis de gaps
npx @zuclubit/momoto-ui gap-analysis

# Reporte de conformance
npx @zuclubit/momoto-ui audit --format=html --output=./reports
```
...
| Recurso | URL |
|---------|-----|
| Documentación | `/packages/momoto-ui/docs/` |
| Ejemplos | `/packages/momoto-ui/examples/` |
...
| L2: Slack | #momoto-ui-support | < 4 horas |
