...
use super::perceptual_loss::{XyzColor, Illuminant, xyz_to_rgb};
...
pub const CIE_X_BAR: [f64; 31] = [
    ...
    0.43345, 0.59450, 0.76210, 0.91630, 1.02630,
    1.06220, 1.00260, 0.85445, 0.64240, 0.44790,
...
pub const CIE_Y_BAR: [f64; 31] = [
    0.00040, 0.00120, 0.00400, 0.01160, 0.02300,
    0.03800, 0.06000, 0.09100, 0.13902, 0.20802,
    0.32300, 0.50300, 0.71000, 0.86200, 0.95400,
    0.99495, 0.99500, 0.95200, 0.87000, 0.75700,
    0.63100, 0.50300, 0.38100, 0.26500, 0.17500,
    0.10700, 0.06100, 0.03200, 0.01700, 0.00821,
    0.00410,
];

/// CIE 1931 2-degree Standard Observer z̄(λ) values (400-700nm, 10nm steps)
pub const CIE_Z_BAR: [f64; 31] = [
    0.06785, 0.20740, 0.64560, 1.38560, 1.74706,
    1.77211, 1.66920, 1.28764, 0.81295, 0.46518,
    0.27200, 0.15820, 0.07825, 0.04216, 0.02030,
    0.00875, 0.00390, 0.00210, 0.00165, 0.00110,
    0.00080, 0.00034, 0.00019, 0.00005, 0.00002,
...
pub const ILLUMINANT_D50_SPD: [f64; 31] = [
    ...
    95.72, 96.17, 97.03, 102.10, 100.75,
    102.32, 100.00, 97.74, 98.92, 93.50,
    97.69, 99.27, 99.04, 95.72, 98.86,
    95.67, 98.19, 103.00, 99.13, 87.38,
    91.60,
];
...
pub fn spectral_to_xyz(spectrum: &[f64; WAVELENGTH_COUNT], config: &SpectralRenderConfig) -> XyzColor {
...
pub fn spectral_to_srgb(spectrum: &[f64; WAVELENGTH_COUNT], config: &SpectralRenderConfig) -> [f64; 3] {
...
mod tests {
    ...
    #[test]
    fn test_cct_d65() {
        let d65_xyz = XyzColor { x: 95.047, y: 100.0, z: 108.883 };
