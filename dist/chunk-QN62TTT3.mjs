import { TypeGuards, BrandConstructors, failure, success } from './chunk-445P5ZF2.mjs';
...
var PerceptualColor = class _PerceptualColor {
  ...
  constructor(oklch, options = {}) {
    ...
    // PRIVATE STATE
    // ─────────────────────────────────────────────────────────────────────────
    __publicField(this, "_oklch");
    __publicField(this, "_alpha");
    __publicField(this, "_gamutMapped");
    // Lazy-evaluated caches
    __publicField(this, "_hexCache");
    __publicField(this, "_rgbCache");
    __publicField(this, "_hslCache");
    __publicField(this, "_hctCache");
    __publicField(this, "_analysisCache");
...
var EnterprisePolicy = class _EnterprisePolicy {
  ...
  constructor(config) {
    ...
    __publicField(this, "enforcement");
  ...
  static create(config) {
    ...
    return success(new _EnterprisePolicy(config));
  }
  /**
...
var GovernanceEvaluator = class {
  constructor() {
    ...
    // ─────────────────────────────────────────────────────────────────────────
    __publicField(this, "customEvaluators", /* @__PURE__ */ new Map());
  }
  // ─────────────────────────────────────────────────────────────────────────
  // PUBLIC API
  // ─────────────────────────────────────────────────────────────────────────
...
export { APCA_THRESHOLDS, AccessibilityService, ENTERPRISE_POLICIES, EnterprisePolicy, GovernanceEvaluator, PerceptualColor, PolicySet, WCAG_THRESHOLDS, accessibilityService, createDefaultPolicySet, createLenientPolicySet, createStrictPolicySet, governanceEvaluator };
//# sourceMappingURL=chunk-QN62TTT3.mjs.map
//# sourceMappingURL=chunk-QN62TTT3.mjs.map