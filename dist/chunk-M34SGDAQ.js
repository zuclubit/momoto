...
var CssVariablesAdapter = class {
  ...
  constructor(options = {}) {
    ...
    chunkZM4FIU5F_js.__publicField(this, "registeredThemes", /* @__PURE__ */ new Map());
    chunkZM4FIU5F_js.__publicField(this, "activeTheme", null);
    chunkZM4FIU5F_js.__publicField(this, "isDarkMode", false);
    chunkZM4FIU5F_js.__publicField(this, "styleElement", null);
    chunkZM4FIU5F_js.__publicField(this, "themeChangeListeners", /* @__PURE__ */ new Set());
    chunkZM4FIU5F_js.__publicField(this, "systemPrefsListeners", /* @__PURE__ */ new Set());
    chunkZM4FIU5F_js.__publicField(this, "mediaQueryList", null);
  ...
  async apply(config) {
    if (!this.isAvailable()) {
      return chunk5YMPXU57_js.failure(new Error("CSS adapter requires DOM environment"));
    }
    try {
  ...
  async toggleDarkMode(options) {
    if (!this.activeTheme) {
      return chunk5YMPXU57_js.failure(new Error("No active theme to toggle"));
    }
    const currentTheme = this.registeredThemes.get(this.activeTheme);
    if (!currentTheme) {
      return chunk5YMPXU57_js.failure(new Error("Active theme not found"));
    }
  ...
  async listThemes() {
    return chunk5YMPXU57_js.success(Array.from(this.registeredThemes.keys()));
  }
  // ─────────────────────────────────────────────────────────────────────────
  // PREFERENCES
  // ─────────────────────────────────────────────────────────────────────────
  async getPreferences() {
    ...
    try {
      ...
      return chunk5YMPXU57_js.success(stored ? JSON.parse(stored) : {});
    } catch {
      return chunk5YMPXU57_js.success({});
    }
  }
  async setPreferences(preferences) {
    if (!this.isAvailable()) {
      return chunk5YMPXU57_js.failure(new Error("Storage not available"));
    }
    try {
  ...
  async syncWithSystem() {
    ...
    if (!prefsResult.success) {
      return chunk5YMPXU57_js.failure(prefsResult.error);
    }
  ...
  async getVariable(variableName) {
    if (!this.isAvailable()) {
      return chunk5YMPXU57_js.success(null);
    }
    try {
      const root = document.documentElement;
      const value = getComputedStyle(root).getPropertyValue(variableName).trim();
      return chunk5YMPXU57_js.success(value || null);
    } catch (error) {
      return chunk5YMPXU57_js.failure(
  ...
  async setVariable(variableName, value) {
    if (!this.isAvailable()) {
      return chunk5YMPXU57_js.failure(new Error("DOM not available"));
    }
    try {
  ...
  async getAllVariables() {
    ...
    try {
      ...
      return chunk5YMPXU57_js.success(variables);
    } catch (error) {
      return chunk5YMPXU57_js.failure(
...
exports.CssVariablesAdapter = CssVariablesAdapter;
exports.CssVariablesAdapter_default = CssVariablesAdapter_default;
//# sourceMappingURL=chunk-M34SGDAQ.js.map
//# sourceMappingURL=chunk-M34SGDAQ.js.map