...
function ColorSwatch({
  ...
  const backgroundColor = react.useMemo(() => color.hex, [color]);
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("div", { className: `color-swatch ${className}`, children: [
    /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        ...
        children: showValue && size !== "sm" && /* @__PURE__ */ jsxRuntime.jsx(
          "span",
          {
            style: {
              color: textColor,
    ...
    showValue && contrastInfo && size !== "sm" && /* @__PURE__ */ jsxRuntime.jsxs(
      "div",
      {
        style: {
          marginTop: 2,
...
function ColorScale({
  ...
  return /* @__PURE__ */ jsxRuntime.jsx(ColorSwatchGroup, { className, children: colors.map((item, index) => /* @__PURE__ */ jsxRuntime.jsx(
    ColorSwatch,
    {
      color: item.color,
      size,
...
function TokenDisplay({
  ...
  if (format === "grid") {
    return /* @__PURE__ */ jsxRuntime.jsx(
      "div",
      {
        ...
        children: tokens.map((t, index) => /* @__PURE__ */ jsxRuntime.jsx(
          TokenCard,
          {
            token: t,
            showMetadata,
  ...
  if (format === "table") {
    return /* @__PURE__ */ jsxRuntime.jsx("div", { className: `token-display token-display--table ${className}`, children: /* @__PURE__ */ jsxRuntime.jsxs(
      "table",
      {
        style: {
          width: "100%",
        ...
        children: [
          /* @__PURE__ */ jsxRuntime.jsx("thead", { children: /* @__PURE__ */ jsxRuntime.jsxs("tr", { children: [
            showPath && /* @__PURE__ */ jsxRuntime.jsx("th", { style: tableHeaderStyle, children: "Path" }),
            /* @__PURE__ */ jsxRuntime.jsx("th", { style: tableHeaderStyle, children: "Value" }),
            /* @__PURE__ */ jsxRuntime.jsx("th", { style: tableHeaderStyle, children: "Type" }),
            showMetadata && /* @__PURE__ */ jsxRuntime.jsx("th", { style: tableHeaderStyle, children: "Description" })
          ] }) }),
          /* @__PURE__ */ jsxRuntime.jsx("tbody", { children: tokens.map((t, index) => /* @__PURE__ */ jsxRuntime.jsx(
            TokenTableRow,
            {
              token: t,
              showMetadata,
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs(
    "div",
    {
      ...
      children: [
        ...
        showPath && /* @__PURE__ */ jsxRuntime.jsx(
          "div",
          {
            style: {
              fontFamily: "monospace",
        ...
        showMetadata && data.description && /* @__PURE__ */ jsxRuntime.jsx(
          "div",
          {
            style: {
              fontSize: fontSize ? fontSize - 2 : 12,
...
function TokenTableRow({ token, showMetadata, showPath }) {
  ...
  return /* @__PURE__ */ jsxRuntime.jsxs("tr", { children: [
    showPath && /* @__PURE__ */ jsxRuntime.jsx("td", { style: { ...cellStyle, fontFamily: "monospace" }, children: data.path }),
    /* @__PURE__ */ jsxRuntime.jsx("td", { style: cellStyle, children: /* @__PURE__ */ jsxRuntime.jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8 }, children: [
      isColor && /* @__PURE__ */ jsxRuntime.jsx(
        "div",
        {
          style: {
      ...
      /* @__PURE__ */ jsxRuntime.jsx("code", { children: formatValue(data.value) })
    ] }) }),
    /* @__PURE__ */ jsxRuntime.jsx("td", { style: cellStyle, children: data.type }),
    showMetadata && /* @__PURE__ */ jsxRuntime.jsx("td", { style: cellStyle, children: data.description ?? "-" })
  ] });
}
...
//# sourceMappingURL=chunk-3TMKA3SC.js.map
//# sourceMappingURL=chunk-3TMKA3SC.js.map