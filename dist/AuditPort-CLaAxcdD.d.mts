import { R as Result, P as PerceptualColor, b as UIState } from './UIState-CG23I-mF.mjs';
 ...
 *
 * @module momoto-ui/application/ports/outbound/AuditPort
 * @version 1.0.0
 */
 ...
 */
type AuditCategory = 'color-decision' | 'accessibility' | 'token-generation' | 'token-modification' | 'theme-change' | 'export' | 'import' | 'validation' | 'performance';
/**
 ...
 */
interface ColorDecisionAudit extends AuditEntry {
 ...
 */
interface AccessibilityAudit extends AuditEntry {
 ...
 */
interface TokenGenerationAudit extends AuditEntry {
...
interface AuditStats {
    ...
    readonly topIssueComponents: Array<{
        name: string;
        count: number;
    }>;
}
...
export type { AuditPort as A, ColorDecisionAudit as C, TokenGenerationAudit as T, AuditSeverity as a, AuditCategory as b, AuditStats as c, AccessibilityAudit as d, AuditEntry as e, AuditFilter as f, AuditReport as g };
