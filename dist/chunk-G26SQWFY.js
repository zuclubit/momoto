...
var InMemoryAuditAdapter = class {
  ...
  constructor(options = {}) {
    ...
    chunkZM4FIU5F_js.__publicField(this, "archivedEntries", []);
    chunkZM4FIU5F_js.__publicField(this, "entryCounter", 0);
  ...
  async log(entry) {
    try {
      ...
      return chunk5YMPXU57_js.success(id);
    } catch (error) {
  ...
  async query(filter) {
    try {
      ...
      return chunk5YMPXU57_js.success(results);
    } catch (error) {
      return chunk5YMPXU57_js.failure(
  ...
  async generateReport(startDate, endDate) {
    try {
      ...
      return chunk5YMPXU57_js.success(report);
    } catch (error) {
      return chunk5YMPXU57_js.failure(
  ...
  async getStats() {
    try {
      ...
      return chunk5YMPXU57_js.success(stats);
    } catch (error) {
      return chunk5YMPXU57_js.failure(
  ...
  async export(filter, format) {
    ...
    if (!queryResult.success) {
      return chunk5YMPXU57_js.failure(queryResult.error);
    }
    const entries = queryResult.value;
    switch (format) {
      case "json":
        return chunk5YMPXU57_js.success(JSON.stringify(entries, null, 2));
      case "csv": {
        if (entries.length === 0) {
          return chunk5YMPXU57_js.success("id,timestamp,category,severity,message,correlationId\n");
        }
        ...
        return chunk5YMPXU57_js.success(csv);
      }
      case "html": {
...
<body>
  ...
  <table>
    ...
    <tbody>${rows}</tbody>
        ...
        return chunk5YMPXU57_js.success(html);
      }
      default:
        return chunk5YMPXU57_js.failure(new Error(`Unsupported format: ${format}`));
    }
  }
  // ─────────────────────────────────────────────────────────────────────────
  // MAINTENANCE METHODS
  ...
  async purge(olderThan) {
    try {
      ...
      return chunk5YMPXU57_js.success(purgedCount);
    } catch (error) {
      return chunk5YMPXU57_js.failure(
  ...
  async archive(olderThan) {
    try {
      ...
      this.entries = this.entries.filter((e) => e.timestamp >= olderThan);
      return chunk5YMPXU57_js.success(toArchive.length);
    } catch (error) {
      return chunk5YMPXU57_js.failure(
...
//# sourceMappingURL=chunk-G26SQWFY.js.map
//# sourceMappingURL=chunk-G26SQWFY.js.map