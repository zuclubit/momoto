...
var ConformanceChecker = class {
  ...
  constructor() {
    ...
    // PROPERTIES
    // ─────────────────────────────────────────────────────────────────────────
    __publicField(this, "checks", /* @__PURE__ */ new Map());
...
var ContrastRatioCheck = class {
  constructor() {
    __publicField(this, "id", "contrast-ratio");
    __publicField(this, "name", "WCAG Contrast Ratio");
    __publicField(this, "category", "accessibility");
    __publicField(this, "description", "Validates color combinations meet WCAG 2.1 AA contrast requirements");
  }
  async run(context) {
    const issues = [];
...
var ColorBlindnessCheck = class {
  constructor() {
    __publicField(this, "id", "color-blindness");
    __publicField(this, "name", "Color Blindness Accessibility");
    __publicField(this, "category", "accessibility");
    __publicField(this, "description", "Validates colors are distinguishable for color-blind users");
  }
  async run(context) {
    const issues = [];
    const colors = context.colors;
...
var PerceptualUniformityCheck = class {
  constructor() {
    __publicField(this, "id", "perceptual-uniformity");
    __publicField(this, "name", "Perceptual Uniformity");
    __publicField(this, "category", "color-intelligence");
    __publicField(this, "description", "Validates color scales have perceptually uniform steps");
  }
  async run(context) {
    const issues = [];
...
var GamutBoundaryCheck = class {
  constructor() {
    __publicField(this, "id", "gamut-boundary");
    __publicField(this, "name", "Gamut Boundary");
    __publicField(this, "category", "color-intelligence");
    __publicField(this, "description", "Validates colors are within displayable gamut");
  }
  async run(context) {
    const issues = [];
    const colors = context.colors;
...
var HardcodedColorCheck = class {
  constructor() {
    __publicField(this, "id", "hardcoded-colors");
    __publicField(this, "name", "No Hardcoded Colors");
    __publicField(this, "category", "color-intelligence");
    __publicField(this, "description", "Validates no hardcoded color values exist outside the design system");
  }
  async run(context) {
    const issues = [];
...
var TokenNamingConventionCheck = class {
  constructor() {
    __publicField(this, "id", "token-naming");
    __publicField(this, "name", "Token Naming Convention");
    __publicField(this, "category", "tokens");
    __publicField(this, "description", "Validates token paths follow naming conventions");
  }
  async run(context) {
    const issues = [];
    const tokens = context.tokenCollection;
...
var TokenCompletenessCheck = class {
  constructor() {
    __publicField(this, "id", "token-completeness");
    __publicField(this, "name", "Token Completeness");
    __publicField(this, "category", "tokens");
    __publicField(this, "description", "Validates required token categories are present");
    __publicField(this, "requiredCategories", [
      "color.primary",
      "color.background",
      "color.text"
    ]);
...
var TokenTypeValidationCheck = class {
  constructor() {
    __publicField(this, "id", "token-type-validation");
    __publicField(this, "name", "Token Type Validation");
    __publicField(this, "category", "tokens");
    __publicField(this, "description", "Validates token values match their declared types");
  }
  async run(context) {
    const issues = [];
    const tokens = context.tokenCollection;
...
var DependencyDirectionCheck = class {
  constructor() {
    __publicField(this, "id", "dependency-direction");
    __publicField(this, "name", "Dependency Direction");
    __publicField(this, "category", "architecture");
    __publicField(this, "description", "Validates dependencies point inward (hexagonal architecture)");
  }
  async run(context) {
    const issues = [];
    const sourceCode = context.sourceCode ?? [];
...
var PortContractCheck = class {
  constructor() {
    __publicField(this, "id", "port-contract");
    __publicField(this, "name", "Port Contract Definition");
    __publicField(this, "category", "architecture");
    __publicField(this, "description", "Validates ports define proper contracts with Result types");
    /**
     * Pattern to detect class exports (ports should be interfaces)
     */
    __publicField(this, "classExportPattern", /export\s+class\s+\w+Port/);
    /**
     * Pattern to detect interface exports (expected for ports)
     */
    __publicField(this, "interfaceExportPattern", /export\s+interface\s+(\w+Port)/g);
    /**
     * Pattern to detect Promise returns without Result wrapper
     */
    __publicField(this, "barePromisePattern", /:\s*Promise<(?!Result)[^>]+>/);
    /**
     * Pattern to detect Result type usage
     */
    __publicField(this, "resultTypePattern", /Result<[^>]+>/);
  }
  async run(context) {
    const issues = [];
    const sourceCode = context.sourceCode ?? [];
...
export { ColorBlindnessCheck, ConformanceChecker, ContrastRatioCheck, DependencyDirectionCheck, GamutBoundaryCheck, HardcodedColorCheck, PerceptualUniformityCheck, PortContractCheck, ReportGenerator, TokenCompletenessCheck, TokenNamingConventionCheck, TokenTypeValidationCheck, conformance_default, report_generator_default };
//# sourceMappingURL=chunk-5UB2HXAF.mjs.map
//# sourceMappingURL=chunk-5UB2HXAF.mjs.map