import { PerceptualColor, accessibilityService } from './chunk-QN62TTT3.mjs';
import { failure, success, BrandConstructors } from './chunk-445P5ZF2.mjs';
...
var UIState = class _UIState {
  ...
  static from(value) {
    ...
    return success(new _UIState(value));
  }
  /**
...
var UIStateMachine = class {
  constructor(initial = UIState.idle(), maxHistory = 10) {
    ...
    __publicField(this, "_maxHistory");
...
var UIRole = class _UIRole {
  ...
  static from(value) {
    ...
    return success(new _UIRole(value));
  }
  /**
...
var ComponentIntent = class _ComponentIntent {
  ...
  static from(value) {
    ...
    return success(new _ComponentIntent(value));
  }
  /**
   * Crea sin validación.
   */
...
var UXDecision = class _UXDecision {
  ...
  constructor(id, request, tokens, governance, config) {
    ...
    __publicField(this, "_governance");
    __publicField(this, "_config");
    __publicField(this, "_createdAt");
    __publicField(this, "_status");
    __publicField(this, "_auditTrail");
    this._id = id;
  ...
  static deriveColor(brand, role, state, intent) {
    ...
    switch (role.value) {
      ...
      case "text-inverse":
        ...
        color = analysis.contrastMode === "light-content" ? PerceptualColor.fromOklch(0.98, 0, 0) : PerceptualColor.fromOklch(0.15, 0, 0);
        break;
      case "border":
    ...
    if (intent.isDestructive && role.isAccent) {
      color = PerceptualColor.fromOklch(0.55, 0.22, 25);
    }
    return color;
  }
  /**
...
var DesignToken = class _DesignToken {
  ...
  constructor(name, value, category, description, context, provenance, deprecated = false, deprecationMessage) {
    ...
    __publicField(this, "_value");
    __publicField(this, "_category");
    __publicField(this, "_description");
    __publicField(this, "_context");
    __publicField(this, "_provenance");
    __publicField(this, "_deprecated");
    __publicField(this, "_deprecationMessage");
    this._name = name;
    this._value = value;
  ...
  static colorFromHex(name, hex, context = {}, description = "") {
    ...
    return success(_DesignToken.color(name, colorResult.value, context, description));
  }
  /**
...
var TokenDerivationService = class {
  ...
  constructor(config = {}) {
    ...
    // ─────────────────────────────────────────────────────────────────────────
    __publicField(this, "_config");
    __publicField(this, "_stateRules");
  ...
  deriveContrastText(backgroundColor) {
    ...
    if (bgL < 0.55) {
      return PerceptualColor.fromOklch(0.98, 0, 0);
    } else {
      return PerceptualColor.fromOklch(0.15, 0, 0);
    }
  }
  /**
  ...
  deriveRoleColor(brandColor, role) {
    ...
    switch (role.value) {
      case "background":
        return PerceptualColor.fromOklch(0.99, 5e-3, oklch.h);
      case "surface":
        return PerceptualColor.fromOklch(0.97, 8e-3, oklch.h);
      ...
      case "text-inverse":
        return PerceptualColor.fromOklch(0.98, 5e-3, oklch.h);
      case "border":
...
export { COMPONENT_INTENTS, ComponentIntent, DEFAULT_CONFIG, DEFAULT_DERIVATION_CONFIG, DesignToken, INTENT_CATEGORIES, INTENT_SEVERITY, INTENT_VARIANTS, LIGHTNESS_SCALE, ROLE_ACCESSIBILITY, RolePair, STATE_DERIVATION_RULES, STATE_PRIORITY, STATE_TRANSITIONS, TokenCollection, TokenDerivationService, UIRole, UIState, UIStateMachine, UI_ROLES, UI_STATES, UXDecision };
//# sourceMappingURL=chunk-YC4E5BUD.mjs.map
//# sourceMappingURL=chunk-YC4E5BUD.mjs.map